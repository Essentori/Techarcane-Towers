...
public class FPVCameraEffects : MonoBehaviour
{
    ...
    void AnimateCameraEffects()
    {
        ...
        bool isStepping = _movement.Controller.isGrounded && _player.State.IsMoving;
    ...
    private void HandleStateChange(CamState newState)
    {
        if (newState == CamState.FirstPersonView) return;
        ResetEffects();
    }
